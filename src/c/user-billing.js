...
const userBilling = {
    oninit(vnode) {
        ...
        const user = vnode.attrs.user,
            ...
            fields = {
                owner_name: console.warn("m.prop has been removed from mithril 1.0") || m.prop(''),
            ...
            bankInput = console.warn("m.prop has been removed from mithril 1.0") || m.prop(''),
        ...
        return m('[id=\'billing-tab\']', [
            ...
            m('.w-row',
                m('.w-col.w-col-10.w-col-push-1', [
                    m(`form.simple_form.refund_bank_account_form`, {onsubmit: vnode.state.onSubmit}, [
                        ...
                        m('.w-form.card.card-terciary', [
                            ...
                            m('.w-row', [
                                m(`.w-col.w-col-6.w-sub-col${vnode.state.showOtherBanksInput() ? '.w-hidden' : ''}[id='bank_select']`,
