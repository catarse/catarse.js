    ...
    view(ctrl, args) {
        return m('.pop-share', {
            ...
            m('a.w-hidden-small.widget-embed.w-hidden-tiny.fontsize-small.link-hidden.fontcolor-secondary[href="js:void(0);"]', {
                ...
                m('.w-form', [
                    m('input.w-input[type="text"][value="<iframe frameborder="0" height="340px" src="https://www.myjvn.com/en/projects/' + args.project().project_id + '/embed" width="300px" scrolling="no"></iframe>"]')
                ]),
                m('.card-embed', [
