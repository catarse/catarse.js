...
const Flex = {
    oninit() {
        const stats = console.warn("m.prop has been removed from mithril 1.0") || m.prop([]),
            projects = console.warn("m.prop has been removed from mithril 1.0") || m.prop([]),
            l = console.warn("m.prop has been removed from mithril 1.0") || m.prop(),
            ...
            m('.w-section.hero-full.hero-zelo', [
                ...
                m('.w-section.section', [
                    m('.w-container', [
                        ...
                        vnode.state.projectsLoader() ? h.loader() : m(
                            projectRow,
                            { collection: vnode.state.projects, ref: 'ctrse_flex', wrapper: '.w-row.u-margintop-40' }
                        )
                    ])
                ]),
                m('.w-section.divider'),
                ...
                m('.w-section.section-large.u-text-center.bg-purple', [
                    ...
                    m('.w-container.u-text-center', [
                        ...
                        m('.w-row.u-text-center', (vnode.state.statsLoader()) ? h.loader() : [
                            m('.w-col.w-col-4', [
